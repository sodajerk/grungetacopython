...
default_option2 = """2. Head south out the back door and forget about all the
...
default_option3 = """3. Try to open the safe by guessing the last number of the
...
default_intro_text = """You enter the Grunge Taco kitchen. There's blood
...
safe_no_mon_intro_text = """You are still in the Grunge Taco kitchen."""

safe_no_mon_option3 = "3. Try to open the safe again" + default_option3[23:]

# elif "money" in inventory:

money_intro_text = """You are still in the Grunge Taco kitchen. But now you are
rich!"""

money_option2 = default_option2[:74] + default_option2[110:-1] + " and spend the rest of the night counting all\
 your money!"

money_option3 = ""

# array for dynamic intro text options
dynam_txt_arr = [default_intro_text, default_option2, default_option3,
                 safe_no_mon_intro_text, safe_no_mon_option3, money_intro_text,
                 money_option2, money_option3]

# outline for dynamic intro text

kitch_dynamic_intro = """%s
...
kitch_lobby_death = """You exit the kitchen and head back into the lobby. You
...
kitch_winning_text = """You open the back door and head into the alley. You
...
kitch_bear_death = """You open the back door and head into the alley. Today
...
kitch_safe_is_open = """You guessed the correct combination! You open up the
...
kitch_default_death = "you %s and it kills you"


# Array for kitchen text strings
kitchen_txt_arr = [kitch_dynamic_intro, kitch_lobby_death, kitch_winning_text,
                   kitch_bear_death, kitch_safe_is_open, kitch_default_death]

# Text strings for lobby_room

lobby_intro_text = """You exit the restroom and enter the main lobby area of
...
lobby_restroom_death = """You decide that this situation is way out of the
...
lobby_outside_death = """You decide you've had enough of Grunge Taco.
...
lobby_untie_death = """You decide to help Ray-Ray and Deshaun. Hopefully they
...
lobby_default_death = """You decide to %s. You've always been good at
...
"""
# lobby text array
lobby_txt_arr = [lobby_intro_text, lobby_restroom_death, lobby_outside_death,
                 lobby_untie_death, lobby_default_death]

# text statements for start room
start_intro_text = """You wake up in the handicapped restroom stall of Grunge
...
start_stall_death = """You decide the best course of action in this situation
...
start_closet_death = """Action movies have taught you that if you ever find
...
start_default_death = """You try to %s and that seems to be the right choice.
You just keep %s-ing and %s-ing. You never realized how wonderful %s-ing could
be. But then suddenly you develop a deadly allergy to %s. You try to scream
but your throat closes up. You try to dial 911 but your phone battery is dead
from all the %s-ing you were doing. You soon die from acute %s poisoning."""

# array for start room texts
start_txt_arr = [start_intro_text, start_stall_death, start_closet_death,
                 start_default_death]
